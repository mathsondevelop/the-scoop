...
// ROUTES SECTION WITH COMMENTS ROUTES
const routes = {
  '/users': {
...
// isValidComment
function isValidComment(requestComment) {
...
function createComment(url, request) {
  ...
  // isValidComment
  if (isValidComment(requestComment)) {
    let comment = {
    ...
    database.nextCommentId = database.nextCommentId + 1;
